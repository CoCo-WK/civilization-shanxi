...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    OneViewCon.tabBarItem.title=@"首页";
    OneViewCon.tabBarItem.image=[UIImage imageNamed:@"首页.png"];
    twoViewCon.tabBarItem.title=@"文明";
    twoViewCon.tabBarItem.image=[UIImage imageNamed:@"信息.png"];
    threeViewCon.tabBarItem.title=@"传统";
    threeViewCon.tabBarItem.image=[UIImage imageNamed:@"公益.png"];
    fourViewCon.tabBarItem.title = @"更多";
    fourViewCon.tabBarItem.image = [UIImage imageNamed:@"我.png"];
    
    UITabBarController *tabber = [[UITabBarController alloc]init];
    tabber.viewControllers = @[OneViewCon,twoViewCon,threeViewCon,fourViewCon];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "-01.____" in the application's documents directory.
